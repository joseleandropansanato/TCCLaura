Module PropriedadesResistencia
    ...
    Public Function eixo2XX(eixoXX As Double, resistenciaCalCompressaoParalela As Double) As Boolean
        Return (eixoXX) <= resistenciaCalCompressaoParalela
    End Function
    Public Function eixo2YY(eixoYY As Double, resistenciaCalCompressaoParalela As Double) As Boolean
        Return (eixoYY) <= resistenciaCalCompressaoParalela
    End Function
    '3 ELEMENTOS JUSTAPOSTOS
    Public Function eixo3XX(eixoXX As Double, resistenciaCalCompressaoParalela As Double) As Boolean
        Return (eixoXX) <= resistenciaCalCompressaoParalela
    End Function
    Public Function eixo3YY(eixoYY As Double, resistenciaCalCompressaoParalela As Double) As Boolean
        Return (eixoYY) <= resistenciaCalCompressaoParalela
    End Function
